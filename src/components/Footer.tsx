    ...
    <footer className="section-dark border-t border-border py-16">
      <div className="container mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="font-body text-xs text-muted-foreground mb-3 font-light italic">{t('footer.tagline')}</p>
          <p className="font-body text-xs text-muted-foreground font-light">3456 W El Segundo Blvd<br />Hawthorne, CA 90250</p>
        </div>

        {/* Services */}
        <div>
          <h4 className="font-display text-foreground text-base mb-4">{t('footer.servicos')}</h4>
          <ul className="font-body text-xs text-muted-foreground space-y-2.5 font-light">
        ...
        {/* Company */}
        <div>
          <h4 className="font-display text-foreground text-base mb-4">{t('footer.empresa')}</h4>
          <ul className="font-body text-xs text-muted-foreground space-y-2.5 font-light">
        ...
        {/* Contact */}
        <div>
          <h4 className="font-display text-foreground text-base mb-4">{t('footer.contato')}</h4>
          <ul className="font-body text-xs text-muted-foreground space-y-2.5 font-light">
